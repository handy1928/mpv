...
function Controls:init()
	...
	local shorthands = {
		...
		deinterlace = 'command:wifi_channel:script-binding autodeint?Deinterlace',
		...
		prev = 'command:arrow_back_ios:script-binding keypress/previous_episode?Previous',
		next = 'command:arrow_forward_ios:script-binding keypress/next_episode?Next',
