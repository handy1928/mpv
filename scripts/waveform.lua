...
mp.add_key_binding(nil, "toggle-waveform", toggleFilter)
mp.add_key_binding(nil, "cycle-waveform-type", cycleFmt)
mp.add_key_binding(nil, "toggle-waveform-position", togglePos)
